    ...
    <div className="space-y-6">
      <section className="rounded-lg border bg-card p-5 shadow-soft">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-sm text-muted-foreground">{data.patient.patientCode}</p>
            <h1 className="mt-1 text-2xl font-semibold tracking-normal">Prescription builder</h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <Field label="Instructions" error={formState.errors.instructions?.message}>
              <textarea className="clinic-focus min-h-28 w-full rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm" {...register("instructions")} />
            </Field>
            ...
            <div className="flex justify-end">
              <Button type="button" onClick={() => void handleSave()} disabled={createPrescription.isPending}>
